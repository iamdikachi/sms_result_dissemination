...
export default function SmsSimulator({ students, onSmsSentOrReceived, smsLogs }: SmsSimulatorProps) {
  ...
  return (
    <div className="w-full flex flex-col h-[680px] bg-slate-900 text-white rounded-3xl overflow-hidden border border-slate-800 shadow-2xl relative">
      {/* Simulation Banner */}
      <div className="bg-gradient-to-r from-blue-700 to-indigo-800 px-5 py-4 flex items-center justify-between border-b border-slate-800">
      ...
      <div className="p-4 bg-slate-950 border-b border-slate-800/80 flex flex-col gap-3">
        {/* Student Selector */}
        <div>
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto px-4 py-5 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-950 via-slate-950 to-black flex flex-col justify-between min-h-[400px]"
      >
          ...
          {activeChatLogs.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center p-6 text-slate-500">
              ...
              <p className="text-[11px] text-slate-500 max-w-[200px]">
                Use the quick buttons below or type an SMS command to query the server database.
              </p>
            </div>
          ) : (
        ...
        <div className="mt-4 pt-3 border-t border-slate-900">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              disabled={isSending}
              className="flex items-center justify-center gap-1.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 rounded-xl py-2 px-2 text-xs transition-colors hover:text-white"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 rounded-xl py-2 px-2 text-xs transition-colors hover:text-white disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isSending || !activeStudent}
              className="flex items-center justify-center gap-1.5 bg-indigo-950/50 hover:bg-indigo-900/60 border border-indigo-800/40 text-indigo-200 rounded-xl py-2 px-2 text-xs transition-colors hover:text-white disabled:opacity-50"
      ...
      >
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-600 text-white p-2.5 rounded-2xl transition-all duration-200"
        >
          {isSending ? (
